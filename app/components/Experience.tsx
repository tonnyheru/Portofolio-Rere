...
const jobs = [
  ...
  },
  {
    ...
    tag: "",
    accentColor: "#6b7280",
    desc: "Menjalankan berbagai peran mulai dari customer service & kasir, administrasi gudang produksi, hingga purchasing dan administrasi printing untuk mendukung kelancaran operasional perusahaan.",
    highlights: [
      "Memberikan pelayanan pelanggan yang responsif dan mengelola transaksi serta pesanan secara sistematis",
      "Menyusun laporan kas harian dengan administrasi yang rapi dan akurat",
